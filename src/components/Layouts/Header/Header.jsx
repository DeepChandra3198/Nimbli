    ...
    return <div className="header">
        ...
        <div className="header-user">
            ...
            <Link to={route.salesDashboard} className="logo logo-normal">
                ...
                {/* <img src="/assets/img/KypeCRMlogo.png" alt="Logo" style={{ width: "200px", height: 'auto' }} /> */}
                <img src="/assets/img/nibliLogo.png" alt="Logo" style={{ width: "200px", height: 'auto' }} />
                {/* <img src="/assets/img/webkype_img.png" className="white-logo" alt="Logo" /> */}
            </Link>
            <Link to={route.salesDashboard} className=" logo-small">
            <img src="/assets/img/nibliLogo.png" alt="Logo" style={{ width: "200px", height: 'auto',padding:'0 15px' }} />
            {/* <img src="/assets/img/webkype_img.png" className="white-logo" alt="Logo" /> */}
            </Link>
                    ...
                    <a href="#"
                        ...
                        <span className="user-info">
                            <span className="user-letter">
                                <img src={profilePic ? profilePic : "https://w7.pngwing.com/pngs/184/113/png-transparent-user-profile-computer-icons-profile-heroes-black-silhouette-thumbnail.png"} alt="Profile" />
                            </span>
