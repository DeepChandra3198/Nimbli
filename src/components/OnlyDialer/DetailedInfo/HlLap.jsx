...
const HlLap = () => {
  ...
  const propertyTypeOptions = [
    ...
    { value: "rented-residential", label: "Rented Residential" },
    { value: "self-occupied-commercial", label: "Self-Occupied Commercial" },
    { value: "rented-commercial", label: "Rented Commercial" },
    { value: "vacant-commercial", label: "Vacant Commercial" },
    { value: "self-occupied-industrial", label: "Self-Ocuupied Indutrial" },
    { value: "rented-industrial", label: "Rented Industrial" },
            ...
            <form onSubmit={handleSubmit} className="mt-3">
              <div className="row">
                ...
                <div className="col-md-4">
                  <div className="form-wrap">
                    <label className="col-form-label">
                      Property Pin Code <span className="text-danger">*</span>
                    </label>
                    <Select
                      classNamePrefix="react-select"
                      className="select"
                      options={options}
                      placeholder="Select Property Pincode"
                      inputValue={propertyPinCode}
                      onInputChange={handlePropertyPinCodeChange}
                      isSearchable={true}
                    />
                  </div>
                </div>
                <div className="col-md-4">
                  <div className="form-wrap">
                    <label className="col-form-label">
                      Property State <span className="text-danger"></span>
                    </label>
                    <Select
                      classNamePrefix="react-select"
                      className="select"
                ...
                <div className="col-md-4">
                  <div className="form-wrap">
                    <label className="col-form-label">
                      Property City <span className="text-danger"></span>
                    </label>
                    <Select
                      classNamePrefix="react-select"
                      className="select"
