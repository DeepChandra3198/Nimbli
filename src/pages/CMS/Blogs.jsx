                ...
                <div className="dropdown table-action">
                    ...
                    <div className="dropdown-menu dropdown-menu-right">
                        <Link className="dropdown-item" to="#">
                            <i className="ti ti-edit text-primary" /> Edit
                        </Link>
                        <Link
                                ...
                                <div className="row align-items-center">
                                    <div className="col-4">
                                        <h4 className="page-title">
                                            Blogs<span className="count-title">12</span>
                                        </h4>
                                    </div>
                                ...
                                <div className="accordion-lists" id="list-accord">
                                    ...
                                    <div className="user-accordion-item">
                                        <Link to="#" className="accordion-wrap" data-bs-toggle="collapse" data-bs-target="#blog-info">
                                            <span><i className="ti ti-news" /></span>
                                            Blog Info
                                        </Link>
                                        <div className="accordion-collapse collapse" id="blog-info" data-bs-parent="#list-accord">
                                                ...
                                                <div className="row">
                                                    <div className="col-md-6">
                                                        <div className="form-wrap">
                                                            ...
                                                            <Select
                                                                className="select"
                                                                options={[]} // Add actual category options here
                                                    ...
                                                    <div className="col-md-12">
                                                        <div className="form-wrap">
                                                            <label>Banner <span className="text-muted">(1920x700, MAX: 2MB)</span></label>
                                                            <input
                                                                type="file"
                                                                className="form-control"
                                                                accept="image/*"
