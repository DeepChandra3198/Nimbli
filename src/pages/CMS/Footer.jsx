                                ...
                                <div className="row align-items-center">
                                    <div className="col-4">
                                        <h4 className="page-title">
                                            Footer<span className="count-title">12</span>
                                        </h4>
                                    </div>
                            ...
                            <div className="pro-create">
                                <div className="accordion-lists" id="list-accord">
                                    ...
                                    <div className="user-accordion-item">
                                        <Link to="#" className="accordion-wrap" data-bs-toggle="collapse" data-bs-target="#category-info">
                                            <span><i className="ti ti-tags" /></span>
                                            Category Info
                                        </Link>
                                        <div className="accordion-collapse collapse" id="category-info" data-bs-parent="#list-accord">
