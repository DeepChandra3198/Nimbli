                                ...
                                <div className="row align-items-center">
                                    <div className="col-4">
                                        <h4 className="page-title">
                                            Web Pages<span className="count-title">12</span>
                                        </h4>
                                    </div>
                    ...
                    <div className="toggle-body">
                        <form action="#" className="toggle-height">
                            <div className="pro-create">
                                <div className="accordion-lists" id="list-accord">
                                    <div className="user-accordion-item">
                                        <Link to="#" className="accordion-wrap" data-bs-toggle="collapse" data-bs-target="#page-info">
                                            <span><i className="ti ti-file-description" /></span>
                                            Page Info
                                        </Link>
                                        <div className="accordion-collapse collapse show" id="page-info" data-bs-parent="#list-accord">
                                            <div className="content-collapse">
                                                <div className="row">
                                                    <div className="col-md-12">
                                                        <div className="form-wrap">
                                                            <label>Page Name <span className="text-danger">*</span></label>
                                                            <input type="text" className="form-control" placeholder="Enter page name" required />
                                                        </div>
                                                    </div>
                                                    <div className="col-md-12">
                                                        <div className="form-wrap">
                                                    ...
                                                    <div className="col-md-12">
                                                        <div className="form-wrap">
                                                            ...
                                                            <textarea className="form-control editor" rows="6" placeholder="Enter page content"></textarea>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-12">
                                                        <div className="form-wrap">
                                                            <label>
                                                                Page Banner <span className="text-muted">(1000x400, Max 2MB)</span>
                                                            </label>
                            ...
                            <div className="submit-button text-end">
                                ...
                                <Link to="#" className="btn btn-primary">Create Page</Link>
                            </div>
                        </form>
                    </div>
                </div>
