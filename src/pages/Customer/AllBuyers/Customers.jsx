                                ...
                                <div className="row align-items-center">
                                    <div className="col-4">
                                        <h4 className="page-title">
                                            Customers<span className="count-title">109</span>
                                        </h4>
                                    </div>
                            ...
                            <div className="pro-create">
                                <div className="accordion-lists" id="list-accord">
                                    ...
                                    <div className="user-accordion-item">
                                        <Link to="#" className="accordion-wrap" data-bs-toggle="collapse" data-bs-target="#buyer-info">
                                            <span><i className="ti ti-user" /></span>
                                            Buyer Info
                                        </Link>
                                        <div className="accordion-collapse collapse show" id="buyer-info" data-bs-parent="#list-accord">
                                                ...
                                                <div className="row">
                                                    ...
                                                    <div className="col-md-6">
                                                        <div className="form-wrap">
                                                            ...
                                                            <Select className="select" options={[]} placeholder="Select country" classNamePrefix="react-select" />
                                                        </div>
                                                    </div>
                                                    <div className="col-md-6">
                                                        <div className="form-wrap">
                                                            <label>State <span className="text-danger">*</span></label>
                                                            <Select className="select" options={[]} placeholder="Select state" classNamePrefix="react-select" />
                                                        </div>
                                                    </div>
                                                    <div className="col-md-6">
                                                        <div className="form-wrap">
                                                            <label>City <span className="text-danger">*</span></label>
                                                            <Select className="select" options={[]} placeholder="Select city" classNamePrefix="react-select" />
                                                        </div>
                                                    </div>
                                                    <div className="col-md-12">
                                                        <div className="form-wrap">
