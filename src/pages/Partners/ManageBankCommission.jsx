...
const ManageBankCommission = () => {
  ...
  return (
    <>
                ...
                <div className="row align-items-center">
                  <div className="col-4">
                    <h4 className="page-title">
                      Bank Commission<span className="count-title">123</span>
                    </h4>
                  </div>
                                                        ...
                                                        <div className="form-wrap">
                                                            ...
                                                            <Select
                                                                ...
                                                                options={[{ value: 'Choose', label: 'Choose' },
                                                                    ...
                                                                    { value: 'ALMORA URBAN COOPERATIVE BANK LIMITED', label: 'ALMORA URBAN COOPERATIVE BANK LIMITED' },
      ...
      <div className="form-wrap">
        <label className="col-form-label">
        Agent  Category <span className="text-danger">*</span>
        </label>
        <Select
          className="select"
      ...
      {selectedCategory === 'Others' && (
        <div className="form-wrap mt-4">
          <label className="col-form-label">Specify Other Agent Category</label>
...
export default ManageBankCommission;