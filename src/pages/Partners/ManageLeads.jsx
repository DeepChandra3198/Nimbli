...
const ManageLeads = () => {
  ...
  const columns = [
    ...
    {
      title: "Lender Name with Status",
      render: (text, record) => (
        <div className="table-avatar d-flex align-items-center table-padding">
          <span className="profile-split">
            Lender Name:{" "}
            <span className="text-success">{record.lenderName}</span>{" "}|
            Lender Status:{" "}
            <span className="text-danger">{record.lenderStatus}</span>
          </span>
        </div>
      ),
      sorter: (a, b) => a.phone.length - b.phone.length,
                ...
                <div className="row align-items-center">
                  <div className="col-4">
                    <h4 className="page-title">
                      Manage Leads<span className="count-title">123</span>
                    </h4>
                  </div>
