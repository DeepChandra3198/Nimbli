...

    {
      ...
      render: (text, record) => (
        <div className="table-avatar d-flex align-items-center table-padding">
          ...
          <Link to={route.managePartnerConnectDetails} className="profile-split">
            {record.partnerName}
          </Link>
        </div>
      ),
...
<Link to={route.managePartnerConnectDetails}   className="dropdown-item">
                ...
                <div className="row align-items-center">
                  <div className="col-4">
                    <h4 className="page-title">
                      Manage Partner Connect<span className="count-title">123</span>
                    </h4>
                  </div>
...
export default ManagePartnerConnect;
