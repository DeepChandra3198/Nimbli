...
import ManagePartnerPipeLine from "./ManagePartnerPipeline";

const ManagePartnerConnectDetails = () => {
    ...
    const [linkActive, setLinkActive] = useState('Approved');

  const handleStatusChange = (partnerStatus) => {
    console.log("Status changed to:", partnerStatus);
  };
    return (
        <>
            {/* Page Wrapper */}
                            ...
                            <div className="page-header">
                                <div className="row align-items-center">
                                    <div className="col-sm-4">
                                        <h4 className="page-title">Manage Partner Connect Details</h4>
                                    </div>
      ...
      <div className="col-md-12">
        <div className="contact-wrap" style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
          <div className="pipeline-list">
            <ul>
              {partnerStatus.map((stage) => (
                <li key={stage.value}
                  style={{ cursor: 'pointer' }}
                  onClick={() => {
                    handleStatusChange(stage.value);
                    setLinkActive(stage.value);
                  }}
                >
                  <Link to="#" className={linkActive === stage.value ? 'bg-pending' : ''}  data-bs-toggle="modal"  data-bs-target="#added">
                    {stage.label} 
                  </Link>
                </li>
              ))}
...
{/* 
    <Modal id="added">
        ...
        {/* <ManagePartnerPipeLine data={data} handleRefresh={handleRefresh} /> */}
                            ...
                            <div className="stickybar">
                                <div className="contact-sidebar">
                                    ...
                                    <ul className="other-info">
                                        ...
                                        <li>
                                            <span className="other-title">Account No :</span>
                                            <span>1234567891234567</span>
                                        </li>
                                        <li>
                                            <span className="other-title">Account Holder:</span>
                                            <span>Deep Chandra S/O Narayan Chandra</span>
                                        </li>
                                        <li>
                                            <span className="other-title">IFSE:</span>
                                            <span>IDIB213782</span>
                                        </li>
                                        <li>
                                            <span className="other-title">Cheque Docs:</span>
                                            <span>View</span>
                                        </li>
                                    </ul>
                                    ...
                                    <ul className="other-info">
                                        <li>
                                            <span className="other-title">Adhar No:</span>
                                            <span>98765432112345</span>
                                        </li>
                                        <li>
                                            <span className="other-title">Adhar  Docs :</span>
                                            <span>View</span>
                                        </li>
                                        <li>
                                            <span className="other-title">Pan No:</span>
                                            <span>PAN988776</span>
                                        </li>
                                        <li>
                                            <span className="other-title">Pan Docs:</span>
                                            <span> View</span>
                                        </li>
                                        {/* <li>
                                            <span className="other-title">Cheque Docs:</span>
...
export default ManagePartnerConnectDetails;
