                ...
                <div className="row align-items-center">
                  <div className="col-4">
                    <h4 className="page-title">
                      TDS<span className="count-title">123</span>
                    </h4>
                  </div>
...
<div className="col-md-10">
                    <div className="form-wrap radio-wrap" >
                        <label className="col-form-label" style={{ paddingBottom: '5px' }}>Role</label>
                        <div className="d-flex flex-wrap">
                            <div className="radio-btn">
                                <input
                                    ...
                                    name="typeOfWork"
                                    value="client"
                                    // checked={formData.typeOfWork == 'client'}
                                    // onChange={handleInputChange}
                                />
                                <label htmlFor="client">Normal</label>
                            </div>
                            <div className="radio-btn">
                                <input
                                    type="radio"
                                    ...
                                    name="typeOfWork"
                                    value="non-client"
                                    // checked={formData.typeOfWork == 'non-client'}
                                    // onChange={handleInputChange}
                                />
                                <label htmlFor="non-client">Advance</label>
                            </div>
                        </div>
                    </div>
                </div>
