...
const Category = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            dataIndex: "banner",
            render: (text) => (
                <img src={text} alt="banner" style={{ width: "80px", height: "40px" }} />
            ),
        },
        {
            title: "Description",
        ...
        },
        {
            ...
            dataIndex: "featured",
            render: (text) => (
                <span className={`badge ${text ? "bg-success" : "bg-secondary"}`}>
                    {text ? "Yes" : "No"}
                </span>
            ),
        ...
        {
            title: "Last Product Date",
            dataIndex: "lastProductDate",
            render: (text) => <span>{text}</span>,
            sorter: (a, b) => new Date(b.lastProductDate) - new Date(a.lastProductDate),
        },
        {
            title: "Documents",
            dataIndex: "documents",
                                ...
                                <div className="row align-items-center">
                                    <div className="col-4">
                                        <h4 className="page-title">
                                            Brand<span className="count-title">123</span>
                                        </h4>
                                    </div>
                            ...
                            <div className="pro-create">
                                <div className="accordion-lists" id="list-accord">
                                    <div className="user-accordion-item">
                                        ...
                                        >
                                            <span><i className="ti ti-user-plus" /></span>
                                            Basic Info
                                        </Link>
                                        <div
                                                ...
                                                <div className="row">
                                                    <div className="col-md-6">
                                                        <div className="form-wrap">
                                                            <label className="col-form-label">Brand Name <span className="text-danger">*</span></label>
                                                            <input type="text" className="form-control" placeholder="Enter brand name" />
                                                        </div>
                                                    </div>
                                                    <div className="col-md-6">
                                                        <div className="form-wrap">
                                                            <label className="col-form-label">Brand Tag</label>
                                                            <input type="text" className="form-control" placeholder="Enter brand tag" />
                                                        </div>
                                                    </div>
                                                    <div className="col-md-6">
                                                        <div className="form-wrap">
                                                    ...
                                                    <div className="col-md-6">
                                                        <div className="form-wrap">
                                                            <label className="col-form-label">Meta Keyword</label>
                                                            <input type="text" className="form-control" placeholder="e.g. electronics, brand, fashion" />
                                                        </div>
                                                    </div>
                                                    <div className="col-md-12">
                                                        <div className="form-wrap">
                                                            <label className="col-form-label">Meta Description</label>
                                                            <textarea className="form-control" rows="2" placeholder="Enter meta description"></textarea>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-12">
                                                        <div className="form-wrap">
                                                            <label className="col-form-label">Description</label>
                                                            <textarea className="form-control" rows="3" placeholder="Enter brand description"></textarea>
                                                        </div>
                                                    </div>
                                                    <div className="col-md-12">
                                                        {/* <div className="form-wrap">
                      <label className="col-form-label">Size Chart</label>
                      <textarea className="form-control text-editor" rows="5" placeholder="Enter size chart details"></textarea>
                    </div> */}
                                                        <div className="form-wrap">
                                                            <label className="col-form-label">Size Chart</label>
                                                            <ReactQuill
                                    ...
                                    <div className="user-accordion-item">
                                        ...
                                        >
                                            <div className="content-collapse">
                                                <div className="row">
                                                    {["Logo", "Banner", "Brand Certificate", "Resale Auth Letter"].map((label, i) => (
                                                            ...
                                                            <div className="profile-upload">
                                                                ...
                                                                <div className="profile-upload-content">
                                                                    <label className="profile-upload-btn">
                                                                        <i className="ti ti-file-broken" /> Upload {label}
                                                                        <input type="file" className="input-img" />
                                                                    </label>
                                                                    <p>JPG, PDF, or PNG. Max size of 800K</p>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ))}
