...
const Category = () => {
    ...
    const columns = [
        ...
        },
        {
            ...
            render: (text) => <span>{text}</span>,
            sorter: (a, b) => a.filterName.localeCompare(b.filterName),
        },
        {
            title: "Alias",
            dataIndex: "alias",
        ...
        },
        {
            ...
            dataIndex: "mappedCategories",
            render: (text) => <span>{text}</span>,
            sorter: (a, b) => a.mappedCategories.localeCompare(b.mappedCategories),
        },
        {
            title: "Sort ID",
            dataIndex: "sortId",
                                ...
                                <div className="row align-items-center">
                                    <div className="col-4">
                                        <h4 className="page-title">
                                            Category<span className="count-title">123</span>
                                        </h4>
                                    </div>
                        ...
                        <form action="#" className="toggle-height">
                            <div className="pro-create">
                                <div className="accordion-lists" id="list-accord">
                                    ...
                                    <div className="user-accordion-item">
                                        <Link
                                            ...
                                            data-bs-toggle="collapse"
                                            data-bs-target="#filter-info"
                                        >
                                            <span><i className="ti ti-filter" /></span>
                                            Filter Info
                                        </Link>
                                        <div
                                                ...
                                                <div className="row">
                                                    <div className="col-md-6">
                                                        <div className="form-wrap">
                                                            <label className="col-form-label">Filter Name <span className="text-danger">*</span></label>
                                                            <input type="text" className="form-control" placeholder="Enter filter name" />
                                                        </div>
                                                    </div>

                                                    <div className="col-md-6">
                                                        <div className="form-wrap">
                                                            <label className="col-form-label">Filter Alias <span className="text-danger">*</span></label>
                                                            <input type="text" className="form-control" placeholder="Enter filter alias" />
                                                        </div>
                                                    </div>

                                                    <div className="col-md-6">
                                                        <div className="form-wrap">
                                                            <label className="col-form-label">Filter Type <span className="text-danger">*</span></label>
                                                            <Select
                                                                className="select"
                                                                options={[
                                                    ...
                                                    <div className="col-md-6">
                                                        <div className="form-wrap">
                                                            <label className="col-form-label">Display Status <span className="text-danger">*</span></label>
                                                            <Select
                                                                className="select"
                                                                options={[
                              ...
                              <input type="file" className="form-control" />
                                                    ...
                                                    <div className="col-md-6">
                                                        {/* <div className="form-wrap">
                              <label className="col-form-label">Banner</label>
                              <input type="file" className="form-control" />
                            </div> */}
                                                        <div className="profile-upload">
                                                            <div className="profile-upload-img">
                                    ...
                                    <div className="user-accordion-item">
                                        ...
                                        >
                                            <span><i className="ti ti-accessible" /></span>
                                            Access
                                        </Link>
                                        <div
                                            className="accordion-collapse collapse"
                                                        ...
                                                        <div className="radio-wrap form-wrap">
                                                            ...
                                                            <div className="d-flex flex-wrap">
                                                                <div className="radio-btn">
                                                                    <input type="radio" id="public" name="visible" />
                                                                    <label htmlFor="public">Public</label>
                                                                </div>
                                                                <div className="radio-btn">
                                                                    <input type="radio" id="private" name="visible" />
                                                                    <label htmlFor="private">Private</label>
                                                                </div>
                                                                <div className="radio-btn">
                                                                    <input type="radio" id="people" name="visible" />
