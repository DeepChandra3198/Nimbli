                ...
                <div className="row align-items-center">
                  <div className="col-4">
                    <h4 className="page-title">
                      Size-colour<span className="count-title">123</span>
                    </h4>
                  </div>
                    ...
                    >
                      <div className="content-collapse">
                        <div className="row">
                          ...
                          <div className="col-md-6">
                            <div className="form-wrap">
                              <label className="col-form-label">Product Type Name <span className="text-danger">*</span></label>
                              <input type="text" className="form-control" placeholder="Enter product type name" />
                            </div>
                          </div>

                          <div className="col-md-6">
                            <div className="form-wrap">
                              <label className="col-form-label">Display Status</label>
                              <Select
                                className="select"
                                options={[
