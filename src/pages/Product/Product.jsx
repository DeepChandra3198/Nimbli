...
const Product = () => {
    ...
    const categoryOptions = [
      ...
      { value: 'Product One Pager', label: 'Product One Pager' },
      { value: 'Policy Details', label: 'Policy Details' },
      { value: 'Script for Calling', label: 'Script for Calling' },
            ...
            render: () => (
                <div className="dropdown table-action">
                    ...
                    <Link
                        ...
                        // }
                        >
                             <i className="ti ti-eye text-primary"></i>View
                        </Link>
                        <Link
                            className="dropdown-item"
                            to="#"
                        ...
                        // }
                        >
                            <i className="ti ti-edit text-blue" /> Modify
                        </Link>
                        <Link
                            className="dropdown-item"
                            to="#"
                        ...
                        >
                            <i className="ti ti-download text-primary"></i>
                            Download
                        </Link>
                    </div>
                </div>
    ...
    return (
                                                        ...
                                                        <div className="form-wrap">
                                                            ...
                                                            <Select
                                                                ...
                                                                options={[{ value: 'Choose', label: 'Choose' },
                                                                    ...
                                                                    { value: 'OD Business Loan', label: 'OD Business Loan' },
                                                                    { value: 'OD Personal Loan', label: 'OD Personal Loan' },
      ...
      {/* Conditional 'Specify Category' Input */}
      {selectedCategory === 'Others' && (
        <div className="form-wrap mt-4">
          <label className="col-form-label">Specify Category</label>
