...
const Category = () => {
  ...
  const columns = [
    ...
    },
    {
      ...
      dataIndex: "name",
      render: (text, record) => (
        <div className="d-flex align-items-center table-padding">
          <img
            src={record.icon}
            alt="icon"
    ...
    },
    {
      ...
      dataIndex: "mappedCategory",
      render: (text) => <span>{text}</span>,
      sorter: (a, b) => a.mappedCategory.localeCompare(b.mappedCategory),
    },
    {
      title: "Products",
      dataIndex: "products",
                        ...
                        <div className="row">
                          ...
                          <div className="col-md-6">
                            <div className="form-wrap">
                              ...
                              <input type="text" className="form-control" placeholder="e.g. service, online, etc." />
                            </div>
                          </div>
                          ...
                          <div className="col-md-6">
                            <div className="form-wrap">
                              ...
                              <input type="number" className="form-control" placeholder="Enter commission" />
                            </div>
                          </div>

                          <div className="col-md-6">
                            <div className="form-wrap">
                              <label className="col-form-label">Feature on Home</label>
                              <Select
                                className="select"
                                options={[
                                  { value: "yes", label: "Yes" },
